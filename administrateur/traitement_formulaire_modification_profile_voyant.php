...
$code_erreur_fichier_image = $information_fichier_image["error"];
     ...
     switch ($code_erreur_fichier_image) {
            ...
            case UPLOAD_ERR_PARTIAL  :
                 ...
                 header("location:page_administrateur.php?page=modification_profil&err=$message_erreur_image");
                 exit;
                 break;
            ...
            header("location:page_administrateur.php?page=modification_profil&err=3");
            exit;
