<?php
// page du voyant avec tous les choix
//
// controle du cookie si existant on continue sinon retour à l'accueil
if (! isset($_COOKIE["pseudo"]) ) {
   // si pas existant retour à l'accueil
   
   
   echo "sorti du script car accueil voyant cookie non existant";
   exit;
...
sqlite_close($base);
        ...
        if ($ligne["direction"] != "V") { // acreditation non voyant
        
                                echo "page voyant, cookie ok, acreditaton : ".$lign["direction"];
                                exit;
    ...
    <body>   <!-- corp du site qui donne l'affichage -->
             <div id="page">     <!-- définition dea marges du site -->
                   ...
                   <?php                // incorporation du menu de gauche
                        include("menu_gauche_voyant.php");
                   ?>     
                   </div>
